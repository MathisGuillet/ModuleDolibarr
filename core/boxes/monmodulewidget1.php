...
/**
 * \file    modulebuilder/template/core/boxes/monmodulewidget1.php
 * \ingroup monmodule
 * \brief   Widget provided by MonModule
 *
 ...
 */
class monmodulewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "monmodulebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "monmodule@monmodule";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->monmodule->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/monmodule/class/monmodule.class.php";

		// Populate the head at runtime
		$text = $langs->trans("MonModuleBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_monmodule@monmodule',
